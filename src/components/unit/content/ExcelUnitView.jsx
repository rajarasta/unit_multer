...
const ExcelUnitView = ({ content }) => {
  ...
  const handleRowNumberClick = (rowIndex, rowData) => {
    ...
    console.log(`📋 Row ${rowIndex} prepared for copying to right unit:`, rowForCopy);
  };
                ...
                {headers.map((header, cellIndex) => {
                  ...
                  return (
                    <td 
                      ...
                      title={String(value)}
                      onClick={isRowNumberColumn ? () => handleRowNumberClick(row.rowIndex, row) : undefined}
                    >
                      {isRowNumberColumn ? (
                        // Redni broj u vrhu ćelije
